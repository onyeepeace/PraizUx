            ...
            <main>
                ...
                <div className="width">
                    <div className="quickteller-intro">
                        <p className="intro-text">Quickteller is a leading innovative e-commerce platform that aims to make payment for services - airtime, bill payment, online shopping, transfers, remittances, loans, and recurring payments, a seamless everyday life experience.</p>

                        <p>Data revealed that Quickteller Mobile App users were leaving in large numbers to complete transactions on the web. We also observed that people who initiated their sign up process on mobile, typically do not activate their accounts on mobile, they go all the way to the web for activation. Weird!</p>
                    </div>
                    ...
                    <div className="quickteller-ux">
                        ...
                        <div className="ux-role">
                            <ul>
                                ...
                                <li>2. Designed and facilitated the research process and methods.</li>
                                <li>3. Provided Design recommendation and actionable insights.</li>
                                <li>4. Designed a new seamless experience for users.</li>
                                <li>5. Designed a new user interface and align with brand guidelines.</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="focus">
                    <div className="focus-groups">
                        ...
                        <div className="focus-groups-info">
                            <p className="users">Participants were recruited from the Quickteller database. Active users were defined as users who have performed a transaction at least once a week for the past 3 months. 4 people were confirmed for the focus group on Wednesday 23rd October, but only 2 were present for the session.</p>

                            <p>During the sessions, participants were asked questions about their experience using Quickteller, how they used it, what other financial services apps they used, and more. <br />
                            At the end of each session, participants were sent gift cards valued at N5,000.</p>
                            ...
                            <div className="questions">
                                ...
                                <ul>
                                    ...
                                    <li>5. How would you describe the look and feel of Quickteller?</li>
                ...
                <div className="quantitative-research">
                    ...
                    <p>We conducted user surveys. The data team provided the data based on the selected users for the survey test.</p>
                </div>
                ...
                <div className="qualitative-research">
                    ...
                    <div className="qualitative-info">
                        <p className="q-info">This was done in 5 days at different locations with 20 participants cutting across our persona and market audience. Users  were tested at locations where they would typically make use of the app for financial transactions.</p>

                        <p>A total of 10 users where tested, they were required to undertake a set of transaction related tasks which enabled us observe their user experience and glean valuable user feedback from them.</p>
                            
                        <p id="q-goal">The goal of the research was to see;
                            <ul>
                ...
                <div className="insights">
                    <div className="research-insights">
                        ...
                        <p><span>Pain Points</span> — The interface looks boring, Information architecture is bad so users find it difficult to navigate through the app.</p>

                        <p><span>Users Expectation</span> — Users expect that the app should carry out core transactions like pay bills, transfer money, buy airtime, these are core to them and termi</p>
                    </div>
                ...
                <p className="new">You can view the new quickteller app here - <a href="www.quickteller.com" target="_blank">Quickteller App</a></p>
            </main>
        );
    }
}
